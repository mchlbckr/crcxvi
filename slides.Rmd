...
plot(vp_gbm, bar_width = 2) + ylab("1 - AUC") + theme_light() + theme(legend.position = "none") + 
  ggtitle("","")
```
]
...
.pull-left70[
<div class = "wrap">
<iframe class = "frame"  src="http://gosiewska.com/examples/xai_in_credit_scoring/"></iframe>
</div>
]
...
https://en.fh-muenster.de/wirtschaft/index.php
]
